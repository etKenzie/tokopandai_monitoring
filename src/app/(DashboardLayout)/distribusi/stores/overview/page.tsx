...
const StoresOverviewPage = () => {
  ...
  console.log('Stores Overview Access Check:', accessCheck);
  ...
  return (
    <PageContainer title="Stores Overview" description="View and manage stores">
      <Box>
        {/* Header */}
        <Box mb={3}>
...
export default function ProtectedStoresOverviewPage() {
  return (
